public class Main {
    ...
    public static void main(String[] args) {
        ...
        Time time = new Time( 8, 43, 19 );
        Data data = new Data();
        Contato contato = new Contato( "Thalles", "thalles@gmail.com");
        Ponto2D ponto2D = new Ponto2D(3, 4);
        Circulo circulo = new Circulo(4);
        RoboSimples robo = new RoboSimples( "Ciborgue", 1, 2, 'N' );

        //Exemplo para a Time
        System.out.println("===== Exemplo para a Classe Time =====");
        System.out.print( "Que horas são? " );
        time.prnTime();
        System.out.println("Adicionando 2h à hora atual");
        time.addTime( 2 );
        ...
        System.out.println("Distância do ponto (2,3): " + ponto2D.distancia(2,3));
        System.out.println("Distância do ponto (0,0): " + ponto2D.distancia());
        ...
        //Exemplo para a Classe RoboSimples
        System.out.println("===== Exemplo para a Classe RoboSimples =====");
        System.out.println(robo.toString());
        System.out.println("\nRobô válido? " + robo.validaRobo());
